<header>
			...
			<div class="head-right">
				...
				<div class="head-right-bottom">
						...
						<a class="main-menu" onclick="window.open('inpatient_form.php', 'popup', 'width=1000, height=500')">입원 환자정보 입력</a>
						<a class="main-menu" href="show_inpatient_if.php">입원 환자 정보 열람</a>
						<a class="main-menu" onclick="window.open('room_setting_form.php', 'popup', 'width=1000, height=500')">입원실 등록</a>
						<a class="main-menu" onclick="window.open('room_if.php', 'popup', 'width=1000, height=500')">입원실 확인</a>
