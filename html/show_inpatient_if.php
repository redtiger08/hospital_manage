...
<?php
	...
	$query = $db->query("select * from inpatient$bid order by inpatient_array desc limit $start, $numLines");
...
<tr>	
	...
	<br>
		...
		$numRecords = $db->query("select count(*) from inpatient$bid")->fetchColumn();
